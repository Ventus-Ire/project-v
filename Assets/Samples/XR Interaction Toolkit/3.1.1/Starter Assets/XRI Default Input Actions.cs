...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""SpellActions"",
            ""id"": ""9daf0847-e462-458f-9c29-2701d4d00be2"",
            ""actions"": [
                {
                    ""name"": ""Shoot"",
                    ""type"": ""Button"",
                    ""id"": ""e7659a8c-811d-4382-ac4b-d184fc179f2d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""85952f1b-ffe1-4440-9120-795def917183"",
                    ""path"": ""<XRController>{RightHand}/{TriggerButton}"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        // SpellActions
        m_SpellActions = asset.FindActionMap("SpellActions", throwIfNotFound: true);
        m_SpellActions_Shoot = m_SpellActions.FindAction("Shoot", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_SpellActions.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.SpellActions.Disable() has not been called.");
    }
    ...
    // SpellActions
    private readonly InputActionMap m_SpellActions;
    private List<ISpellActionsActions> m_SpellActionsActionsCallbackInterfaces = new List<ISpellActionsActions>();
    private readonly InputAction m_SpellActions_Shoot;
    /// <summary>
    /// Provides access to input actions defined in input action map "SpellActions".
    /// </summary>
    public struct SpellActionsActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public SpellActionsActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "SpellActions/Shoot".
        /// </summary>
        public InputAction @Shoot => m_Wrapper.m_SpellActions_Shoot;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_SpellActions; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="SpellActionsActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(SpellActionsActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="SpellActionsActions" />
        public void AddCallbacks(ISpellActionsActions instance)
        {
            if (instance == null || m_Wrapper.m_SpellActionsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SpellActionsActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="SpellActionsActions" />
        private void UnregisterCallbacks(ISpellActionsActions instance)
        {
            @Shoot.started -= instance.OnShoot;
            @Shoot.performed -= instance.OnShoot;
            @Shoot.canceled -= instance.OnShoot;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="SpellActionsActions.UnregisterCallbacks(ISpellActionsActions)" />.
        /// </summary>
        /// <seealso cref="SpellActionsActions.UnregisterCallbacks(ISpellActionsActions)" />
        public void RemoveCallbacks(ISpellActionsActions instance)
        {
            if (m_Wrapper.m_SpellActionsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="SpellActionsActions.AddCallbacks(ISpellActionsActions)" />
        /// <seealso cref="SpellActionsActions.RemoveCallbacks(ISpellActionsActions)" />
        /// <seealso cref="SpellActionsActions.UnregisterCallbacks(ISpellActionsActions)" />
        public void SetCallbacks(ISpellActionsActions instance)
        {
            foreach (var item in m_Wrapper.m_SpellActionsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SpellActionsActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="SpellActionsActions" /> instance referencing this action map.
    /// </summary>
    public SpellActionsActions @SpellActions => new SpellActionsActions(this);
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "SpellActions" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="SpellActionsActions.AddCallbacks(ISpellActionsActions)" />
    /// <seealso cref="SpellActionsActions.RemoveCallbacks(ISpellActionsActions)" />
    public interface ISpellActionsActions
    {
        /// <summary>
